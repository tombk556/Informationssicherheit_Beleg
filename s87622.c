...
{
    const char *srcPath = "decrypted.bin";
    const char *destPath = "s87622-result.bin";
...
int main(void)
{
    ...
    /* Verschlüsselungsprozess und Ausgabe der Datei s87622-result.bin */
    encryptFile(key2, iv2);
